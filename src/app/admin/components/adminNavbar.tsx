...
// const AdminNavbar: React.FC<Props> = ({ toggleShowSideBar, isSidebarOpen }) => {
//   const [isClient, setIsClient] = useState(false)
//   const { data: session } = useSession()
...
//           <Button variant="ghost" size="icon" onClick={toggleShowSideBar} className="mr-4" aria-label="Toggle sidebar">
//             {isSidebarOpen ? <X size={20} /> : <Menu size={20} />}
//           </Button>

//           <div className="hidden lg:block text-xl font-bold text-purple-700">Admin Dashboard</div>
//         </div>
