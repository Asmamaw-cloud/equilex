...
//       break;
//     case 'failed':
//       message = `Payment failed. Transaction Reference: ${tx_ref || 'N/A'}. Please try again.`;
//       icon = '❌';
//       statusClass = 'bg-red-100 text-red-800';
//       break;
//     case 'pending':
//       message = `Payment is pending. Transaction Reference: ${tx_ref || 'N/A'}. We'll notify you once it's confirmed.`;
//       icon = '⏳';
...
//         <div className={`max-w-md mx-auto p-6 rounded-lg shadow-lg ${statusClass}`}>
